...
<div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-green-500 to-transparent" />
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-white/10">
        ...
        <div className="px-6 pb-6 space-y-5">
          <ul className="space-y-3">
            {[
              { step: '1', color: 'from-green-500 to-emerald-500', text: 'Install QSender on your Windows PC.' },
              { step: '2', color: 'from-emerald-500 to-teal-500', text: 'Open the app — it will show you a unique Device ID.' },
              { step: '3', color: 'from-green-500 to-teal-500', text: 'Complete your purchase and share the Device ID with our support team.' },
...
export default function Download() {
  ...
  const handleWindowsDownload = () => {
    ...
    link.href = 'https://github.com/inteloite/qsender/releases/download/V1.0.1/QSender.Setup.1.0.0.exe';
    link.download = 'QSender Setup 1.0.0.exe';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-xl text-gray-400 max-w-2xl mx-auto px-4">
              Download QSender software and start automating your WhatsApp campaigns instantly.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch max-w-2xl mx-auto px-4">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-emerald-500 blur-xl sm:blur-2xl opacity-50 group-hover:opacity-75 transition-opacity animate-pulse"></div>
            ...
            <button className="group relative px-8 sm:px-10 py-4 sm:py-5 rounded-xl overflow-hidden flex-1 sm:min-w-[240px]">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-green-600"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-green-600 blur-xl sm:blur-2xl opacity-50 group-hover:opacity-75 transition-opacity animate-pulse" style={{ animationDelay: '0.5s' }}></div>
              <div className="relative flex items-center justify-center gap-3 text-white">
